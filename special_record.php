...
<link rel="stylesheet" type="text/css" href="resource/css/other.css">
        <div class="rightpanel">
            <div class="container">
                <h1 class="devicelist">西湖区特殊住户列表</h1>
                <ul class="operat">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th>
                                ...
                                <option value="">手机开门</option>
                                <option value="">app开门</option>
                                <option value="">呼叫开门</option>
                                <option value="">蓝牙开门</option>
                                </select>
                            </th>
                            <th>地址</th>
                            <th>图像</th>
